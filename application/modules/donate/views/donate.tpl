<div id="donate">
	{if $donate_paypal.use || $donate_paygol.use}
		<div id="donate_select">
			{if $donate_paypal.use}<a href="javascript:void(0)" onClick="Donate.showPayPal(this)" class="nice_active button-normal">{lang("paypal", "donate")}</a>{/if}
			{if $donate_paygol.use}<a href="javascript:void(0)" onClick="Donate.showPayGol(this)" class="{if !$donate_paypal.use}nice_active{/if} button-normal">{lang("paygol", "donate")}</a>{/if}
		</div>
