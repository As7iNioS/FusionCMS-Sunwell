        ...
        {foreach from=$realms item=realm}
            ...
            <div class="realm-border"
                ...
                <div class="realm-text">Up: {$realm->getUptime()} <span style="color: darkcyan; font-weight: bold;">&nbsp;|&nbsp;</span>
                    Graczy: {$realm->getOnline()}<span style="color: darkcyan; font-weight: bold;">&nbsp;|&nbsp;</span>
                    Max: {$realm->getMaxPlayerCount()}
                </div>
            </div>
        {/foreach}
    </div>
