...
class PVP_Statistics extends MX_Controller
{
    ...
    {
        $this->template->setTitle(lang("statistics_title", "pvp_statistics"));
        ...
        $this->template->box(lang("statistics_title", "pvp_statistics"), $output, true, "modules/pvp_statistics/css/style.css", "modules/pvp_statistics/js/scripts.js");
    }
}
