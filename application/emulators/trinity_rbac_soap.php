...
class Trinity_rbac_soap implements IEmulator
{
	...
	protected $queries = array(
		...
		"get_account_id" => "SELECT id id, username username, sha_pass_hash password, email email, joindate joindate, last_ip last_ip, last_login last_login FROM account WHERE id = ?",
		"get_account" => "SELECT id id, username username, sha_pass_hash password, email email, joindate joindate, last_ip last_ip, last_login last_login FROM account WHERE username = ?",
