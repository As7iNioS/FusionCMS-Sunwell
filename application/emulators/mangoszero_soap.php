...
class Mangoszero_soap implements IEmulator
{
	protected $config;
	...
	protected $queries = array(
		...
		"get_inventory_item" => "SELECT inv.slot slot, inv.item item, inv.item_template itemEntry FROM character_inventory inv, item_instance ins WHERE inv.item = ins.guid AND inv.slot >= 0 AND inv.slot <= 18 AND ins.owner_guid=? AND inv.bag=0",
